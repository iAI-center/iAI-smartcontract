...
contract VRFIToken is ERC20, ERC20Burnable, Ownable, ERC20Permit {
    constructor(
        address initialOwner,
        uint256 initialSupply
    )
        ERC20("VRFI Token", "VRFI")
        Ownable(initialOwner)
        ERC20Permit("VRFI Token")
    {
        require(
            initialSupply > 0,
            "VRFIToken: initial supply should be greater than 0"
        );
