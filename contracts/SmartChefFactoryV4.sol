...
import "./SmartChefInitializableV4.sol";

contract SmartChefFactoryV4 is Ownable {
    ...
    function deployPool(
        ...
        bytes memory bytecode = type(SmartChefInitializableV4).creationCode;
        ...
        SmartChefInitializableV4(smartChefAddress).initialize(
            _stakedToken,
            _rewardToken,
            _rewardPerBlock,
            _startBlock,
